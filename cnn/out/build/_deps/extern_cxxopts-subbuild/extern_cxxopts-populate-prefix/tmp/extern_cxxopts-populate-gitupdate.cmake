...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.2.0"
  WORKING_DIRECTORY "/workspace/wut-mini-deep-learning/cnn/extern/cxxopts"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.2.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.2.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/jarro2783/cxxopts.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspace/wut-mini-deep-learning/cnn/extern/cxxopts'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/wut-mini-deep-learning/cnn/extern/cxxopts'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
